#ifndef SDNET_ENGINE_extL2_table
#define SDNET_ENGINE_extL2_table
...
//######################################################
class extL2_table { // LookupEngine
public:
	...
	// lookup ctor
	extL2_table(std::string n, std::string _filename = "") : _name(n) , _entries(n, _filename.empty() ? (n + ".tbl") : _filename) { }
	// engine function
	void operator()(){
		std::cout << "===================================================================" << std::endl;
...
extern "C" void extL2_table_DPI(const char*, int, const char*, int, int, int);


} // namespace SDNET

#endif // SDNET_ENGINE_extL2_table
