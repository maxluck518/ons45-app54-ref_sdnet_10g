...
add_files ./src/packet_pipeline_input.v
add_files ./src/small_fifo_v3.v
add_files ./src/user_data_path_mon.v
add_files ./sim/tb_pipeline.v

set_property top packet_pipeline_input [current_fileset]
...
ipx::associate_bus_interfaces -busif s_axis_rxd_2 -clock s_axis_rxd_aclk [ipx::current_core]
ipx::associate_bus_interfaces -busif s_axis_rxd_3 -clock s_axis_rxd_aclk [ipx::current_core]
